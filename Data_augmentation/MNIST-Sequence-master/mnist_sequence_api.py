...
class MNIST_Sequence_API(object):
    ...
    def generate_mnist_sequence(self, digits, spacing, image_width):
        ...
        img_data = (self.sequence_object.generate_image_sequence(digits, spacing, image_width) * 255.0).astype(np.uint8)
        return img_data
