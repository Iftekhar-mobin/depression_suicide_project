...
\newblock{\em Praxis international journal of social science and literature}, vol. 6, pages 1-18, 2023.

\bibitem{noauthor_bangladesh_2021}
Bangladesh {Education} {Statistics} 2021.


\bibitem{daily_star_01}
Mohiuddin Alamgir
\newblock HSC pass rate, GPA-5 dip.
\newblock {\em https://www.thedailystar.net/news/bangladesh/education/news/hsc-pass-rate-gpa-5-dip-3479641}, November 27, 2023.

\bibitem{Difficulties_English_Speaking}
Amin, Md Ruhul.
...
\newblock {\em Indonesian Journal Of Educational Research and Review}, 161-175, April, 2023.

\bibitem{Complexities_teaching_english}
...
\newblock {\em JOURNAL OF LANGUAGE}, 34-48, 2022.


\bibitem{chang2021applying}
...
\newblock Applying text mining, clustering analysis, and latent dirichlet
  ...
  journals.
\newblock {\em Sustainability}, 13(19):10856, 2021.

\bibitem{chen2020detecting}
...
\newblock {\em Computers \& Education}, 151:103855, 2020.

\bibitem{gencoglu2023machine}
...
\newblock {\em Computers \& Education}, 193:104682, 2023.

\bibitem{hamzah2020discovering}
...
\newblock {\em Applied Sciences}, 11(18):8438, 2021.

\bibitem{korean2021research}
Eun~Hee Park.
\newblock Research trends in college english education in korea-a topic
  analysis using lda topic modeling.
\newblock {\em Korean Journal of General Education}, 15(5):169--183, 2021.

\bibitem{sakhovskiy2020topic}
...
\bibitem{ali_transportation_2019}
...
\newblock {\em Knowledge-Based Systems}, 174:27--42, June 2019.
...
\newblock {\em Contemporary Educational Psychology}, 60:101827, January 2020.

\bibitem{bethard_topic_2009}
...
\bibitem{chen_evaluating_2016}
Xiaojun Chen.
\newblock Evaluating {Language}-learning {Mobile} {Apps} for {Second}-language
  {Learners}.
\newblock {\em Journal of Educational Technology Development and Exchange},
  9(2), December 2016.

\bibitem{farkhod_lda_based_2021}
Akhmedov Farkhod, Akmalbek Abdusalomov, Fazliddin Makhmudov, and Young~Im Cho.
\newblock {LDA}-{Based} {Topic} {Modeling} {Sentiment} {Analysis} {Using}
  {Topic}/{Document}/{Sentence} ({TDS}) {Model}.
\newblock {\em Applied Sciences}, 11(23):11091, January 2021.
\newblock Number: 23 Publisher: Multidisciplinary Digital Publishing Institute.

\bibitem{guerra_when_2013}
...
\newblock {\em Global Transitions Proceedings}, 3(1):298--304, June 2022.

\bibitem{habib_english_2018}
Wasim~Bin Habib and Tuhin~Shubhra Adhikary.
\newblock English, maths drag results down again, May 2018.

\bibitem{hao_evaluative_2019}
...
\newblock {\em Computers in Human Behavior}, 95:208--216, June 2019.

\bibitem{isamiddinovna_mobile_2019}
...
\bibitem{pichardo_lagunas_svd_lda_2015_1}
Sergey Nikolenko.
\newblock {SVD}-{LDA}: {Topic} {Modeling} for {Full}-{Text} {Recommender}
  {Systems}.
\newblock In Obdulia Pichardo~Lagunas, Oscar Herrera~Alcántara, and Gustavo
...
\newblock {\em Education Sciences}, 9(3):203, September 2019.
...
\newblock {\em Sustainability}, 13(17):9768, January 2021.
\newblock Number: 17 Publisher: Multidisciplinary Digital Publishing Institute.

\bibitem{raj_p_m_sentiment_2022}
...
\newblock {\em Materials Today: Proceedings}, 51:576--584, January 2022.

\bibitem{rani_extractive_2021}
Ruby Rani and D.~K. Lobiyal.
\newblock An extractive text summarization approach using tagged-{LDA} based
  topic modeling.
\newblock {\em Multimedia Tools and Applications}, 80(3):3275--3305, January
  2021.

\bibitem{report_schools_2018}
Star Report.
\newblock Schools of 0, May 2018.

\bibitem{sandberg_mobile_2011}
Jacobijn Sandberg, Marinus Maris, and Kaspar de~Geus.
\newblock Mobile {English} learning: {An} evidence-based study with fifth
  graders.
\newblock {\em Computers \& Education}, 57(1):1334--1347, August 2011.
...
\newblock {\em Applied Sciences}, 9(24):5496, 2019.

\bibitem{shortt_gamification_2023}
...
\newblock {\em Computer Assisted Language Learning}, 36(3):517--554, March
  2023.
\newblock Publisher: Routledge \_eprint:
  https://doi.org/10.1080/09588221.2021.1933540.

\bibitem{slater_using_2017}
...
\newblock A scoping review of digital game-based technology on {English}
  language learning.
\newblock {\em Educational Technology Research and Development},
