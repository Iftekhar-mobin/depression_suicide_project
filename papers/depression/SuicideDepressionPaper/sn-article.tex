...
%
\begin{enumerate}
\item Epidemiology: Investigate risk factors associated with the development of mental health issues.
\item Early Intervention:
- Examine the effectiveness of early detection and intervention in preventing the escalation of mental health issues.
- Investigate school-based programs aimed at identifying and supporting at-risk youth.
\item 
Treatment Modalities: Analyze the effectiveness of text based approach for suicide and depression analysis
\item 
Technology and Mental Health:
- Explore the role of digital mental health interventions, such as how social media footprint can be used to determine mental health status 
- Evaluate the potential of artificial intelligence in predicting and preventing mental health crises.
\end{enumerate}
...
% then coherence score is calculated using an equation \(\sum_{j = 1}^{i}{PMI}\left( w_{i},w_{j} \right)\) which provides negative coherence score. \(c_{v}\) can be expressed as  
%\begin{equation}
