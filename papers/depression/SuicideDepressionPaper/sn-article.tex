...
\begin{document}
\title[Article Title]{Exploratory analysis of the degree of suicidal ideation in depression investigation of social media post}
%%=============================================================%%
%% Prefix       -> \pfx{Dr}
