...
\begin{itemize}
\item Instagram images \cite{mann2020see, ye2021multi}
\item EHR \cite{zheng2020development, mann2020see}
\item Audio visual facial expression \cite{he2022deep}
\end{itemize}
& \begin{itemize}
\item Audio and video features are extracted using LSTM model and Random Forest classifier is used to determine depression class \cite{he2022deep}. 
